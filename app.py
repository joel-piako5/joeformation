...
from questions import questions  # Quiz d'entrainement
...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///etudiants.db')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

db = SQLAlchemy(app)
bcrypt = Bcrypt(app)

# 🔹 Upload folder (local pour tests, mais à remplacer par Object Storage pour production)
...
# 🔹 Vérifie le type de fichier pour upload
